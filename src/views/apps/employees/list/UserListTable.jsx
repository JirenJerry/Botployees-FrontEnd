...
const UserListTable = ({ tableData }) => {
  ...
  const updateSession =async (employeeId)=> {
    await update({currentEmployeeId: employeeId})
      ...
      columnHelper.accessor('action', {
        ...
        cell: ({ row }) => (
          <div className='flex items-center'>
            ...
            <IconButton>
              <Link href={getLocalizedUrl(`/apps/employees/view`, locale)} className='flex'>
                <i className='ri-eye-line text-textSecondary' onClick={()=>updateSession(row.original._id)}/>
              </Link>
            </IconButton>
  ...
  const getAvatar = params => {
    ...
    if (avatar) {
      return <Avatar src={avatar} skin='light' size={34} />
    } else {
      return (
        <Avatar skin='light' size={34}>
